...
<template>
  <div class="flex  flex-col w-72 h-full shadow-md bg-white line-clamp-2">
    <div class="w-72 h-72">
      <img :src="product.imageUrl" :alt="product.name" class="object-cover" />
    </div>
    <div class="h-full">
      <div class="p-6 border-t flex flex-col h-full justify-between">
        ...
        <div class="flex justify-between items-center mt-4">
          ...
          <div class="flex space-x-1">
            ...
            <Button
              variant="outline"
              size="sm"
              class="border-red-100 bg-red-50 text-red-500"
              ><Heart :size="20"
            /></Button>
          </div>
        </div>
